...
def _dubins_path_planning_from_origin(end_x, end_y, end_yaw, curvature,
    ...
    print("theta=%.3f, alpha=%0.3f, beta=%.3f \n" % (theta, alpha, beta))
...
def main():
    ...
    start_x = -2.672  # [m]
    start_y =  3.8002  # [m]
    # start_yaw = np.deg2rad(0.45)  # [rad]
    start_yaw = 0.00058

    end_x =  4.249  # [m]
    end_y = 4.78 # [m]
    end_yaw = np.deg2rad(35)  # [rad]
    ...
    path_x, path_y, path_yaw, mode, lengths = plan_dubins_path(start_x,
                                                               ...
                                                               end_y,
                                                               end_yaw,
                                                               curvature, step_size=0.1, selected_types=["RSL"])
